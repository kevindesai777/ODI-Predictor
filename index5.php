<?php
	...
	if($neutral == 'false'){
		...
		$wp12 = probw($num, $den);
		$lp12=probl($num, $den);
		$res1 = abs(log($wp1 + 0.99)) + abs(log($wp2 + 0.99)) + abs(log($wp3 + 0.99)) + abs(log($wp4 + 0.99)) + abs(log($wp5 + 0.99)) + abs(log($wp6 + 0.99)) + abs(log($wp7 + 0.99)) + abs(log($wp8 + 0.99)) + abs(log($wp9 + 0.99)) + abs(log($wp10 + 0.99)) + abs(log($wp11 + 0.99)) + abs(log($wp12 + 0.99));
		$res2 = abs(log($lp1 + 0.99)) + abs(log($lp2 + 0.99)) + abs(log($lp3 + 0.99)) + abs(log($lp4 + 0.99)) + abs(log($lp5 + 0.99)) + abs(log($lp6 + 0.99)) + abs(log($lp7 + 0.99)) + abs(log($lp8 + 0.99)) + abs(log($lp9 + 0.99)) + abs(log($lp10 + 0.99)) + abs(log($lp11 + 0.99)) + abs(log($lp12 + 0.99)) ;
		$res1=abs(log($res1));
		$res2=abs(log($res2));
		$total = $res1 + $res2;
