...
//echo "<br>";
//wp2
$query="select count(*) as tot from cricket1 where (team1='$t1' OR team2='$t1') AND start_date>='$date' ";
$result=mysqli_query($con,$query);
$row = mysqli_fetch_array($result);
//echo $row['tot'];
$den=$row['tot'];  
//echo "<br>";
$query="select count(*) as tot from cricket1 where (team1='$t1' OR team2='$t1') and winteam='$t1' and start_date>='$date' ";
$result=mysqli_query($con,$query);
$row = mysqli_fetch_array($result);
//echo $row['tot'];
$num=$row['tot']; 
...
$den=$row['tot'];  
//echo "<br>";
$query="select count(*) as tot from cricket1 where (team1='$t1' OR team2='$t1') and winteam='$t1' and start_date>='$date' AND gcountry='$scountry' ";
$result=mysqli_query($con,$query);
$row = mysqli_fetch_array($result);
//echo $row['tot'];
$num=$row['tot']; 
...
//echo "wp12";echo "<br>";
//wp12
$query="select count(*) as tot from cricket1 where (team1='$t2' OR team2='$t2') AND start_date>='$date' ";
$result=mysqli_query($con,$query);
$row = mysqli_fetch_array($result);
//echo $row['tot'];
$den=$row['tot'];  
//echo "<br>";
$query="select count(*) as tot from cricket1 where (team1='$t2' OR team2='$t2') and winteam <> '$t2' AND start_date>='$date' ";
$result=mysqli_query($con,$query);
$row = mysqli_fetch_array($result);
//echo $row['tot'];
$num=$row['tot']; 
